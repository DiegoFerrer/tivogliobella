...
//------------------------------------------------------------------------		
	$(".type").typed({
    	strings: ["Diferente.", "Amor.", "Dinero.", "Salud."],
        typeSpeed: 200,
		backDelay:1500,
		loop: true,
        loopCount: false,
...
//------------------------------------------------------------------------------------		  
    $('#contact_form').validate({
        ...
        messages: {
            name: "Cuales tu nombre?",
            message: "Escribi tu mensaje",
            email: {
                required: "Cual es tu email?",
        ...
        if($(this).valid()){
            ...
            $.ajax({
                ...
                success: function() {
					...
					//Use modal popups to display messages
					$('#modalMessage .modal-title').html('<i class="icon icon-envelope-open"></i>Bien hecho!<br>Tu mensaje a sido enviado correctamente!');
					$('#modalMessage').modal('show');
                },
                error: function() {
                    $('#contact_submit').button('reset');
					...
					//Use modal popups to display messages
					$('#modalMessage .modal-title').html('<i class="icon icon-ban"></i>Oops!<br>Ups algo salio mal!');
					$('#modalMessage').modal('show');
                }
            });
        } else {
